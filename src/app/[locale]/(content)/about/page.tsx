...
export async function generateMetadata({
  ...
  const title = isAr ? "عن سُكان — منصة العقارات السودانية" : "About Sukan — Sudan's Property Platform";
  const description = isAr
    ? "تعرّف على سُكان، المنصة العقارية السودانية الأولى باللغتين العربية والإنجليزية"
